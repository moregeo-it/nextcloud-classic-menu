OC.L10N.register(
    "classic_appmenu",
    {
        ...
        "Choose which apps are shown as icons in the header and which ones go into the waffle menu. Drag the apps between the lists or use the buttons. The order applies to all users and overrides their personal app order.": "Wähle aus, welche Apps als Symbole in der Kopfzeile angezeigt werden und welche ins App-Menü kommen. Ziehe die Apps zwischen den Listen hin und her oder nutze die Schaltflächen. Die Reihenfolge gilt für alle Benutzer und ersetzt deren persönliche App-Reihenfolge.",
        "Top bar": "Kopfzeile",
        ...
        "Apps not listed above (newly installed apps and apps you do not have access to) are shown in the": "Nicht oben aufgeführte Apps (neu installierte Apps und Apps, auf die du keinen Zugriff hast) werden angezeigt in:",
        ...
        "Apps": "Apps",
        "not available to you": "für dich nicht verfügbar",
        ...
        "Saving …": "Speichern …",
        "Saved. Reload the page to see the changes in the header.": "Gespeichert. Lade die Seite neu, um die Änderungen in der Kopfzeile zu sehen.",
        "Could not save the settings": "Die Einstellungen konnten nicht gespeichert werden",
        "Reset to default. Reload the page to see the changes in the header.": "Auf Standard zurückgesetzt. Lade die Seite neu, um die Änderungen in der Kopfzeile zu sehen.",
